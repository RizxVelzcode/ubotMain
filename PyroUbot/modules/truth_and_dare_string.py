TRUTH = [
    ...
    "Apabila kamu cewe bersedia kah untuk menjadi pacar owner ku @rizxvelzdev",
    ...
    "si @rizxvelzdev menurut ku dia ganteng, coba deh kamu chat, trus ajak pacaran hehe ⚠️WARNING ini khusus cewe ya!",
